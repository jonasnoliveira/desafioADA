...
-- CreateTable
CREATE TABLE "PaymentBills" (
    "Id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "Tipo" TEXT NOT NULL,
    "Id_referencia" INTEGER NOT NULL,
    "Data_vencimento" TEXT NOT NULL,
    "Valor" REAL NOT NULL,
    CONSTRAINT "PaymentBills_Id_referencia_fkey" FOREIGN KEY ("Id_referencia") REFERENCES "Bills" ("Referencia") ON DELETE RESTRICT ON UPDATE CASCADE
);
